...
# Ids usados para mergear y borrar

ids_to_delete = ["355", "354", "362", "228", "40", "48", "80",
                 "97", "109", "159", "183", "212", "215", "77",
                 "109", "174", "312", "33", "121", "7", "10", "179",
                 "344", "326", "338", "316", "319", "327", "328",
                 "287", "185", "43", "238","395","128","360","306","170","85","366"]
id_groups = [
    [397, 398],  #
    [381, 382],  # rubiagafas
    [318, 359],  # bobbybro
    [317, 310, 78, 192, 272, 310],  # sergio
    [368, 369, 356, 17, 49, 298, 196, 198],  # manucho
    [33],  # ruben
    [223, 100, 379, 377],  # ux10
    [224, 181, 127, 182],  # metak
    [194, 64],  # Cristian
    [190, 191, 278, 188, 313, 66, 188, 191],  # ruben
    [233, 2, 41],  # barry
    [86, 69, 23, 207],  # jus
    [249, 252, 268],  # chica bandana naranja
    [279, 286, 201, 220],  # chica gafas sol
    [213, 221, 229],  # chica fondo verde
    [276, 243],  # chica gorra amiga Bobby
    [283, 267, 265, 79, 294, 296, 308],  # amiga Bobby kindahot
    [255, 303],  # compa piso
    [305, 309, 315, 117],  # estela
    [266, 11, 58, 63, 72, 234],  # tetas
    [136, 139, 142, 157, 166, 85, 92],  # cuello estirado naranja
    [385, 74, 122, 299],  # kroack
    [114, 186],  # nelson
    [145, 103],  # lucia
    [334, 348, 54, 82],  # elena
    [4, 195],
...
proyecto = "project3-tol0.5 - mergeos y borrados"
check_create_project_paths(proyecto)

delete_faces_by_ids(project_path, ids_to_delete)
merge_faces(project_path,id_groups)



# video = ["Filtered_Facetracking.mp4"]
# proyecto = "project3-tol0.5"
# check_create_project_paths(proyecto)
# store_faces(video, 0.5, proyecto)